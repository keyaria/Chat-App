...
export type FetchLatestMessagesQuery = {
  __typename?: "Queries"
  fetchLatestMessages?: Array<{
    __typename?: "Message"
    messageId: string
    text: string
    datetime: any
...
export type MessagePostMutation = {
  __typename?: "Mutations"
  MessagePost?: { __typename?: "MessageEnum"; messageId: string; text: string; datetime: any; userId: UserId } | null
}
 ...
 * });
 */
export function useMessagesFetchLatestQuery(
  baseOptions: Apollo.QueryHookOptions<MessagesFetchLatestQuery, MessagesFetchLatestQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MessagesFetchLatestQuery, MessagesFetchLatestQueryVariables>(
    MessagesFetchLatestDocument,
    options
  )
}
export function useMessagesFetchLatestLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MessagesFetchLatestQuery, MessagesFetchLatestQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MessagesFetchLatestQuery, MessagesFetchLatestQueryVariables>(
    MessagesFetchLatestDocument,
    options
  )
}
...
export type MessagesFetchLatestQueryResult = Apollo.QueryResult<
  MessagesFetchLatestQuery,
  MessagesFetchLatestQueryVariables
>
 ...
 * });
 */
export function useFetchLatestMessagesQuery(
  baseOptions: Apollo.QueryHookOptions<FetchLatestMessagesQuery, FetchLatestMessagesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<FetchLatestMessagesQuery, FetchLatestMessagesQueryVariables>(
    FetchLatestMessagesDocument,
    options
  )
}
export function useFetchLatestMessagesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchLatestMessagesQuery, FetchLatestMessagesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<FetchLatestMessagesQuery, FetchLatestMessagesQueryVariables>(
    FetchLatestMessagesDocument,
    options
  )
}
...
export type FetchLatestMessagesQueryResult = Apollo.QueryResult<
  FetchLatestMessagesQuery,
  FetchLatestMessagesQueryVariables
>
 ...
 * });
 */
export function useMessagesFetchMoreQuery(
  baseOptions: Apollo.QueryHookOptions<MessagesFetchMoreQuery, MessagesFetchMoreQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MessagesFetchMoreQuery, MessagesFetchMoreQueryVariables>(MessagesFetchMoreDocument, options)
}
export function useMessagesFetchMoreLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MessagesFetchMoreQuery, MessagesFetchMoreQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MessagesFetchMoreQuery, MessagesFetchMoreQueryVariables>(
 ...
 * });
 */
export function useMessagePostMutation(
  baseOptions?: Apollo.MutationHookOptions<MessagePostMutation, MessagePostMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
